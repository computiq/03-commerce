...
# class of entity is like base of fields like it's a default field existing in the other tables,
# for ex all the other tables below have the id and upadeted and created field,
